  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <p className="mt-3 text-slatey">
        ...
        simulados: hay un plantel ficticio con 35 días de historial y un deportista de ejemplo para
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        <Link href="/demo/deportista" className="card p-6 transition-shadow hover:shadow-pop">
          ...
          <p className="mt-2 text-sm text-slatey">
            Completá los 3 formularios (control diario, semanal y evento especial) y mirá cómo cambia
            tu score de riesgo al instante.
          </p>
